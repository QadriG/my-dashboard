    ...
    <div className="dashboard-column open-positions p-4 text-center border-emerald-400">
      ...
      <table className="min-w-full table-auto text-sm text-left text-white">
        ...
        <tbody className="divide-y divide-gray-700">
          <tr>
            <td className="p-2">
              <span className="bg-red-600 text-white px-2 py-1 rounded">2S</span>
            </td>
            <td className="p-2">XMR/USDT:USDT</td>
            <td className="p-2">
              <span className="bg-red-600 text-white px-2 py-1 rounded">Short</span>
            </td>
          ...
          <tr>
            <td className="p-2">
              <span className="bg-green-600 text-white px-2 py-1 rounded">1L</span>
            </td>
            <td className="p-2">UNI/USDT:USDT</td>
            <td className="p-2">
              <span className="bg-green-600 text-white px-2 py-1 rounded">Long</span>
            </td>
