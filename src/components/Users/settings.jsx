  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="ml-64 p-8 overflow-y-auto space-y-10">
        ...
        <div className="bg-black/30 backdrop-blur-md border-2 border-green-400 hover:shadow-[0_0_12px_4px_rgba(34,197,94,0.6)] p-6 rounded-xl w-full mb-10 transition-transform duration-300 transform hover:scale-[1.02] overflow-hidden will-change-transform">
        ...
        <div className="w-full py-4">
          <div className="w-full bg-black/30 backdrop-blur-md border-2 border-red-400 hover:shadow-[0_0_12px_4px_rgba(239,68,68,0.6)] rounded-xl transition-transform duration-300 transform hover:scale-[1.02] overflow-hidden will-change-transform px-6 py-6">
