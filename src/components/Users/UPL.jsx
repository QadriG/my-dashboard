      ...
      <div className="space-y-2">
        <div className="flex justify-between">
          ...
          <span className="text-white-300 drop-shadow">
            ${formatAmount(total)} <span className="text-sm text-gray-400">({formatPercent(totalPercent)}%)</span>
          </span>
        </div>
        <div className="flex justify-between">
          <span>
          ...
          <span className="text-white-300">
            ${formatAmount(long)} <span className="text-sm text-gray-400">({formatPercent(longPercent)}%)</span>
          </span>
        </div>
        <div className="flex justify-between">
          <span>
          ...
          <span className="text-white-300">
            ${formatAmount(short)} <span className="text-sm text-gray-400">({formatPercent(shortPercent)}%)</span>
          </span>
        </div>
      </div>
    </div>
